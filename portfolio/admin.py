...
class MutualfundList(admin.ModelAdmin):
    list_display = ('customer','name','scheme', 'units', 'category', 'purchase_price','purchase_date','return_date','return_price')
    list_filter = ('customer','name','scheme')
    search_fields = ('customer','name','scheme')
    ordering = ['customer']
